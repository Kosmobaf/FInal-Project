...
public final class Constants {
    ...
    public static final String WEB_INF_ADMIN_ALL_USERS_JSP = "/WEB-INF/admin/allUsers.jsp";
    ...
    public static final String REDIRECT_GET_LIST_ORDERS_FOR_USER = "redirect:/getListOrdersForUser";
}
